      ...
      <div className="space-y-4 mx-4 lg:hidden flex flex-col">
        ...
        <ul className="space-y-1 flex flex-col">
          {service.subCategories.map((sub) => (
            ...
            <Link key={sub.title}
              href={`/hizmetlerimiz/${service.slug}/${sub.slug}`} className={`cursor-pointer w-64 p-2 rounded-lg hover:bg-gray-200 ${sub.slug === subCategory ? "bg-gray-300" : ""}`}
            >
              {sub.title}
            </Link>
          ))}
        ...
        <div className="mt-10 mb-6 mx-4 p-6 bg-gradient-to-br bg-red rounded-xl shadow-2xl text-whiteB">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-6 !text-whiteB">
              Eğer {possessiveTitle} için bakım, onarım veya yedek parça ihtiyacınız varsa, bizimle iletişime geçebilirsiniz.
