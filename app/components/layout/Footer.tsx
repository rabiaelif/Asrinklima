    ...
    <div className="bg-blue text-gray-300 py-10">
      <div className="h-auto px-6 mx-auto container">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="col-span-1 gap-8 lg:gap-20 2xl:gap-72 flex flex-col xl:flex-row items-start xl:justify-start">
        ...
        <div className="grid grid-cols-1 mt-8">
          <div className="text-start text-xs sm:text-sm text-gray-300">© 2025 ASRINKLİMA. Tüm Hakları Saklıdır.</div>
        </div>
      </div>
    </div>
  );
